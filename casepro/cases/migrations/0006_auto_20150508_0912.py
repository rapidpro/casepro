...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='action',
            field=models.CharField(max_length=1, choices=[('F', 'Flag'), ('N', 'Un-flag'), ('L', 'Label'), ('U', 'Remove Label'), ('A', 'Archive'), ('R', 'Restore')]),
        ),
        migrations.AddField(
            model_name='caseevent',
            name='case',
            field=models.ForeignKey(related_name='events', to='cases.Case'),
        ),
    ]
