    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("org", models.ForeignKey(related_name="groups", verbose_name="Organization", to="orgs.Org", on_delete=models.PROTECT)),
            ],
            options={},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("org", models.ForeignKey(related_name="labels", verbose_name="Organization", to="orgs.Org", on_delete=models.PROTECT)),
            ],
            options={},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_on", models.DateTimeField(auto_now_add=True)),
                ("created_by", models.ForeignKey(related_name="exports", to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT)),
                ("org", models.ForeignKey(related_name="exports", verbose_name="Organization", to="orgs.Org", on_delete=models.PROTECT)),
            ],
            options={},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("org", models.ForeignKey(related_name="partners", verbose_name="Organization", to="orgs.Org", on_delete=models.PROTECT)),
            ],
            options={},
            bases=(models.Model,),
        ),
        ...
        migrations.AddField(
            ...
            name="assignee",
            field=models.ForeignKey(related_name="case_actions", to="cases.Partner", null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name="caseaction",
        ...
        migrations.AddField(
            model_name="caseaction",
            name="created_by",
            field=models.ForeignKey(related_name="case_actions", to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name="case",
        ...
        migrations.AddField(
            model_name="case",
            name="org",
            field=models.ForeignKey(related_name="cases", verbose_name="Organization", to="orgs.Org", on_delete=models.PROTECT),
            preserve_default=True,
        ),
    ]
