    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("org", models.ForeignKey(related_name="faqs", verbose_name="Organization", to="orgs.Org", on_delete=models.PROTECT)),
                ("parent", models.ForeignKey(related_name="translations", blank=True, to="msgs.FAQ", null=True, on_delete=models.PROTECT)),
            ],
        )
    ]
