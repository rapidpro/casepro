    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("org", models.ForeignKey(related_name="new_labels", verbose_name="Organization", to="orgs.Org", on_delete=models.PROTECT)),
            ],
        ),
        migrations.AddField(
            model_name="messageaction", name="new_label", field=models.ForeignKey(to="msgs.Label", null=True, on_delete=models.PROTECT)
        ),
    ]
