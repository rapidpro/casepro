...
def migrate_messageactions(apps, schema_editor):
    ...
    for old_action in old_actions:
        MessageAction.objects.create(org=old_action.org,
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(max_length=1, choices=[('F', 'Flag'), ('N', 'Un-flag'), ('L', 'Label'), ('U', 'Remove Label'), ('A', 'Archive'), ('R', 'Restore')])),
