    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_by", models.ForeignKey(related_name="message_actions", to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT)),
                ("label", models.ForeignKey(to="cases.Label", null=True, on_delete=models.PROTECT)),
                ("org", models.ForeignKey(related_name="message_actions", verbose_name="Organization", to="orgs.Org", on_delete=models.PROTECT)),
            ],
        ),
