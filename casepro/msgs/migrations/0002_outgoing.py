...
def data_migration(apps, schema_editor):
    ...
    for old in outgoings:
        NewOutgoing.objects.create(org=old.org,
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.CharField(max_length=1, choices=[('B', 'Bulk Reply'), ('C', 'Case Reply'), ('F', 'Forward')])),
                ...
                ('org', models.ForeignKey(related_name='outgoing_messages', verbose_name='Organization', to='orgs.Org')),
            ],
        ),
