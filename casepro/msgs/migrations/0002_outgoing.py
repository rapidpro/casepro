    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("case", models.ForeignKey(related_name="outgoing_messages", to="cases.Case", null=True, on_delete=models.PROTECT)),
                ("created_by", models.ForeignKey(related_name="outgoing_messages", to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT)),
                (
                    "org",
                    models.ForeignKey(related_name="outgoing_messages", verbose_name="Organization", to="orgs.Org", on_delete=models.PROTECT),
                ),
            ],
        ),
