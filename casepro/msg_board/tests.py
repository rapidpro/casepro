...
class CommentTest(BaseCasesTest):
    ...
    def test_comment_list_view(self):
        ...
        response = self.url_get('unicef', reverse('msg_board.comments'))
    ...
    def test_pin_comment(self):
        ...
        response = self.url_get('unicef', reverse('msg_board.pinnedcomment_list'))
    ...
    def test_unpin_invalid_comment(self):
        ...
        response = self.url_post(
            self.unicef,
            reverse('msg_board.pinnedcomment_unpin', kwargs={'pk': 9999})
        )
        self.assertEqual(response.status_code, 403)
