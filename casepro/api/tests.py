...
class APITest(BaseCasesTest):
    ...
    def test_cases(self):
        ...
        case1 = self.create_case(self.unicef, self.ann, self.moh, msg1, [self.aids], summary="Summary 1",
                                 user_assignee=self.user1)
        case2 = self.create_case(self.unicef, self.ann, self.who, msg2, [], summary="Summary 2",
                                 user_assignee=self.user1)

        # case for another org
        msg3 = self.create_message(self.nyaruka, 103, self.bob, "Hola")
        self.create_case(self.nyaruka, self.ann, self.klab, msg3, [self.code], summary="Summary 3",
                                 user_assignee=self.user4)
